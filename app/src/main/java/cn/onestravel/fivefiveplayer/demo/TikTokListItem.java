 ...
 */
public class TikTokListItem extends FrameLayout {
    private FiveVideoView mVideoView;
    private int mState;

    public TikTokListItem(@NonNull Context context) {
        this(context, null);
    }

    public TikTokListItem(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public TikTokListItem(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
